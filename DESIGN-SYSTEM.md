...
- Error state (`.form-error`): yellow background, ink border and bold ink text — deliberately reuses the existing palette rather than introducing a red/error color, per the "never a new color" rule.
